...
<body class="customColorbgBody">
			...
			<section>
				...
				<div class="tab-pane item active" role="tabpanel" id="step1">
						...
						<form role="form" id="homeForm" action="deliveryDetails" method="post">
										...
										<div class="panel panel-primary" style="border: 0px;">
											<div class="panel-body" style="padding: 8px;background-color: #F3AC1F;">
												<ul class="nav nav-tabs navtabcustom">
													...
													<li><a data-toggle="tab" id="comboOrdernav" class="customnav navtabcustom" href="#comboOrder">Combo Order</a></li>
													<li><a data-toggle="tab" id="partyOrdernav" class="customnav navtabcustom" href="#partyOrder">Stall At Home</a></li>
												</ul>
																	...
																	<c:forEach items="${itemList}" var="item">
																		<tr>
																			<td data-th="Product">
																				...
																				<div id="collapseOne${item.itemId}" tabindex="-1" data-backdrop="false" class="modal fade"
																					role="dialog">
																...
																<tbody>
																	<c:forEach items="${comboList}" var="item">
																		<tr>
																			...
																			<td data-th="Price"><span id="itemPrice${item.itemId}"><c:out value="${item.itemPrice}"></c:out></span></td>
																			<td data-th="Quantity" style="padding: 2px;" data-itemId="${item.itemId}"
							...
							<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
								<div class="panel panel-primary" style="background: red;border: 0px;">
									...
									<div id="viewDetails" class="panel-collapse collapse in orderSummary panel-body" style="color:white;">
										<div id="orderSummary" style="line-height: 30px;">
											...
											<div class="row" id="itemSummary">
												<div class="customrow" style="border-bottom: 1px solid yellow; margin-right: 0px"></div>
												<div class="customrow">
										...
										<div class="panel-footer hidden-xs hidden-sm pannelfootercustom">
											<div class="row show continueToDeliverySummary" id="continueToDeliverySummary" style="padding-left: 10%;padding-right: 10%;">
												<div id="continueToDelivery" class="continueToDelivery col-md-12 btn btn-success pannelbuttonscustom">
											...
											<div class="row hide continueToVerifySummary" id="continueToVerifySummary">
												<div id="editOrder" class="editOrder col-md-6 btn btn-success pannelbuttonscustom">
													<span class="glyphicon glyphicon-menu-left"></span>Edit Order
												</div>
												<div id="continueToVerify" class="continueToVerify col-md-6 btn btn-success pannelbuttonscustom">
											...
											<div class="row hide continueToConfirmSummary" id="continueToConfirmSummary">
												<div id="backToAddress" class="backToAddress col-md-6 btn btn-success pannelbuttonscustom">
													<span class="glyphicon glyphicon-menu-left"></span>Back to Address
												</div>
												<div id="confirmOrderButton" class="confirmOrderButton col-md-6 btn btn-success pannelbuttonscustom">
													Confirm Order<span class="glyphicon glyphicon-menu-right"></span>
												</div>
											</div>
											<div class="row hide placeNewOrderSummary" id="placeNewOrderSummary" style="padding-left: 10%;padding-right: 10%;">
												<div id="placeNewOrder" class="placeNewOrder col-md-12 btn btn-success pannelbuttonscustom">
					...
					<div class="row hidden-lg hidden-md">
						<div class="row show continueToDeliverySummary" style="width: 100%; margin-left: 10%"
							id="continueToDeliverySummary">
							<div id="continueToDelivery" style="width: 80%;" class="continueToDelivery col-sm-12 btn btn-success pannelbuttonscustom">
								Continue to DeliveryDetails<span class="glyphicon glyphicon-menu-right"></span>
							</div>

						</div>
						<div class="row hide continueToVerifySummary" style="width: 100%; margin-left: 10%" id="continueToVerifySummary">
							<div id="editOrder" style="width: 40%;" class="editOrder col-md-6 btn btn-success pannelbuttonscustom">
								<span class="glyphicon glyphicon-menu-left"></span>Edit Order
							</div>
							<div id="continueToVerify" style="width: 40%;" class="continueToVerify col-md-6 btn btn-success pannelbuttonscustom">
								Continue to Payment<span class="glyphicon glyphicon-menu-right"></span>
							</div>
						</div>
						<div class="row hide continueToConfirmSummary" style="width: 100%; margin-left: 10%" id="continueToConfirmSummary">
							<div id="backToAddress" style="width: 40%;" class="backToAddress col-md-6 btn btn-success pannelbuttonscustom">
								<span class="glyphicon glyphicon-menu-left"></span>Back to Address
							</div>
							<div id="confirmOrderButton" style="width: 40%" class="confirmOrderButton col-md-6 btn btn-success pannelbuttonscustom">
								Confirm Order<span class="glyphicon glyphicon-menu-right"></span>
							</div>
						</div>
						<div class="row hide placeNewOrderSummary" style="width: 100%; margin-left: 10%" id="placeNewOrderSummary">
							<div id="placeNewOrder" style="width: 80%;" class="placeNewOrder col-md-12 btn btn-success pannelbuttonscustom">
								Place A New Order<span class="glyphicon glyphicon-menu-right"></span>
							</div>
						</div>
	...
	<div class="modal fade bs-example-modal-sm" data-backdrop="static" id="areaModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
						...
						<div class="form-group" id="areaDivElements">
							<div class="row customrow">
								<div class="col-xs-12 col-md-6 customformgroup">
									<input class="form-control customformelements" type="text" maxlength="10" name="phoneNumber"
										id="phoneNumberInit" placeholder="Phone Number" value="" /><span class="icon-place"></span>
								</div>
							</div>
							<div class="row customrow">
								<div class="col-xs-12 col-md-6 control-group customformgroup">
									<div class="controls" id="areaAddrDiv" class="areaAddrDiv">
										<input type="text" class="areaAddr form-control customformelements" id="areaAddr" name="areaAddr"
											placeholder="Search Area/Zipcode" />
									</div>
									<div id="areaMenu" class="areaMenu list-group hide"></div>
								</div>
								<div class="col-xs-12 col-md-6 control-group customformgroup">
									<div class="controls" id="subAreaAddrDiv" class="subAreaAddrDiv">
										<input type="text" class="subAreaAddr form-control customformelements" id="subAreaAddr" name="subAreaAddr"
				...
				<div class="modal-footer">
					<button type="button" id="enterArea" class="btn btn-success">Order Now</button>
				</div>
			</div>
		</div>
	</div>
